...
function new(args, props)
    ...
    props.fg_normal      = props.fg_normal    or theme.fg_normal    or "#999999"
    ...
    irc.widget:buttons(util.table.join(
        button({ }, 3, function () irc.clear() end), -- RIGHT MOUSE: clear highlight
        button({ }, 1, function () toggle(irc); update(irc) end) -- LEFT MOUSE: toggle state
    ))
